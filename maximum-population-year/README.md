...
<pre style="position: relative;"><strong>Input:</strong> logs = [[1993,1999],[2000,2010]]
...
<pre style="position: relative;"><strong>Input:</strong> logs = [[1950,1961],[1960,1971],[1970,1981]]
<strong>Output:</strong> 1960
<strong>Explanation:</strong> 
The maximum population is 2, and it had happened in years 1960 and 1970.
The earlier year between them is 1960.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
